...
describe("Database Connection", function()
    ...
    it("should retrieve MySQL version", function()
    ...
    it("should verify users table exists", function()
        local res, err = db:query("SHOW TABLES LIKE 'users'")
        assert.is_nil(err)
        assert.is_not_nil(res)
        assert.equals(1, #res)
    end)
    ...
    it("should verify posts table exists", function()
        local res, err = db:query("SHOW TABLES LIKE 'posts'")
        assert.is_nil(err)
        assert.is_not_nil(res)
        assert.equals(1, #res)
    end)
    ...
    it("should verify categories table exists", function()
        local res, err = db:query("SHOW TABLES LIKE 'categories'")
        assert.is_nil(err)
        assert.is_not_nil(res)
        assert.equals(1, #res)
    end)
    ...
    it("should verify tags table exists", function()
        local res, err = db:query("SHOW TABLES LIKE 'tags'")
        assert.is_nil(err)
        assert.is_not_nil(res)
        assert.equals(1, #res)
    end)
